function scr_player_grabbed() //scr_player_grabbed
{
    ...
    with (_obj_player)
    {
        ...
        if (!((state == (79 << 0) || (state == (121 << 0) && fightball == 1) || state == (191 << 0) || state == (193 << 0) || state == (192 << 0) || state == (194 << 0) || state == (6 << 0) || state == (55 << 0) || state == (74 << 0) || state == (75 << 0) || state == (20 << 0) || state == (80 << 0) || state == (76 << 0) || state == (81 << 0) || state == (82 << 0) || state == (83 << 0))))
        {
