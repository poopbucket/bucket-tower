/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for calculate_jump_velocity
...
*/
/*
WARNING: Recursive script decompilation (for member variable name resolution) failed for get_projectile_angle
